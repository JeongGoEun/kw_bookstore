...
<%!
   String memberID="";   String bookName="";   int bookPrice=0;
   int bookAmount=0; int buyMonth=0; int buyDate=0;
%>
<%
   ...
   try{
	   memberID=request.getParameter("memberID");   //회원 ID
     ...
     //out.print(memberID +"---" );
         ...
         String query = "select * from soldlist where Mid=" + "'" + memberID + "'" + ";";
         rs = stmt.executeQuery(query);	
         
       /*  while(rs.next()){
            memberID=rs.getString("Mid");
            bookName=rs.getString("BName");
            bookPrice=Integer.parseInt(rs.getString("BPrice"));
           bookAmount=Integer.parseInt(rs.getString("BAmount"));
           buyMonth=Integer.parseInt(rs.getString("BuyMonth"));
            buyDate=Integer.parseInt(rs.getString("BuyDate"));
      }*/
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                    	<center><h2>검색 된 <%=request.getParameter("memberID")%> 회원 주문 정보</h2></center>
                    	<hr class="small">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                   <table class="tblClass" width="600" style="margin-left:60px;border-bottom:1px solid black;">
                       ...
                       <td> <%=rs.getString("BName")%></td>
                  		...
                  		<td><%=Integer.parseInt(rs.getString("BuyMonth"))%></td>
                  		<td><%=Integer.parseInt(rs.getString("BuyDate"))%></td>
                  		</tr>
                  		<%  } %>
                  </table>
                </div>
