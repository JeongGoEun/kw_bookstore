        ...
        <div class="container">
            ...
            <table class="tblClass" width="600" style="margin-left:50px;border-bottom:1px solid black;">
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                   ...
                   <h2 class="list">책 이름 > <input type="text" name="bookName"/></h2>
                   <h2 class="list">&nbsp;&nbsp;저자 > &nbsp;&nbsp;&nbsp;<input type="text" name="bookAuthor"/></h2>
                   <h2 class="list">출판사 > &nbsp;<input type="text" name="bookCompany"/></h2>
                   <input id="searchBtn1" type="submit" value="폐기" onClick="destroy()"/>
